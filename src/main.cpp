...
uint256 hashGenesisBlock("0x09a18e9a661df8944d76ad9f5fae38b89967f8a1de4c7f17201f4957de284630"); //1391750417
...
const string strMessageMagic = "Vampirecoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 800000); // vampirecoin: 800k blocks in ~3.8 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2 * 60 * 60; // Vampirecoin: 2 hour
static const int64 nTargetSpacing = 150; // Vampirecoin: 2.5 minute blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Vampirecoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Vampirecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Vampirecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Vampirecoin Build V.1.0 January 22, 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391750417; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 7892513;
        ...
        assert(block.hashMerkleRoot == uint256("0x0a181f4bbb994efb94b7dd8be77db15d693be09870a5a6ceba665b30229a9bbc"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Vampirecoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
